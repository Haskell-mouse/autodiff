-- /home/rinat/autodiff/autodiff-exp/src/Sized.hs:229:1-15: Splicing declarations
...
-- /home/rinat/autodiff/autodiff-exp/src/Sized.hs:230:1-20: Splicing declarations
...
-- /home/rinat/autodiff/autodiff-exp/src/Sized.hs:231:1-17: Splicing declarations
...
-- /home/rinat/autodiff/autodiff-exp/src/Sized.hs:232:1-19: Splicing declarations
...
instance Data.GADT.Internal.GShow Sized.Var where
  ...
  Data.GADT.Internal.gshowsPrec _ Sized.Y = GHC.Show.showString "Y"
-- /home/rinat/autodiff/autodiff-exp/src/Sized.hs:232:1-19: Splicing declarations
instance Data.Constraint.Extras.ArgDict c_aoKT Sized.Var where
  type Data.Constraint.Extras.ConstraintsFor Sized.Var c_aoKT = (c_aoKT '(4,
                                                                          3),
                                                                 c_aoKT '(3, 2))
  Data.Constraint.Extras.argDict
    = \case
